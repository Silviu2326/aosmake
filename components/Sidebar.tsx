...
export const Sidebar: React.FC<SidebarProps> = ({ currentView, setCurrentView }) => {
  ...
  const menuItems = [
    { id: View.STUDIO, icon: Layout, label: 'Two-Phase Studio' },
    { type: 'divider' },
    { id: View.PRECRAFTER, icon: Zap, label: 'PreCrafter' },
    { id: View.CRAFTER, icon: Blocks, label: 'Crafter' },
    { id: View.SPEC, icon: FileText, label: 'Instructions Spec' },
    { type: 'divider' },
    { id: View.RUNS, icon: History, label: 'Runs' },
    { id: View.EXPERIMENTS, icon: FlaskConical, label: 'Experiments' },
    { id: View.ARTIFACTS, icon: FileJson, label: 'Artifacts' },
    { id: View.DATASETS, icon: Database, label: 'Datasets' },
    { id: View.LIBRARY, icon: GitBranch, label: 'Library' },
    { type: 'spacer' },
        ...
        {menuItems.map((item, index) => {
          ...
          return (
            <button
              ...
              className={`w-full flex items-center px-3 py-2 rounded-md transition-colors group relative ${
                isActive 
