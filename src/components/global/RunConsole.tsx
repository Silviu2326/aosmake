                        ...
                        <div className="flex items-center gap-1" onClick={e => e.stopPropagation()}>
                            {['logs', 'timeline'].map(tab => (
                                <button
                                    ...
                                    className={`px-3 py-1.5 rounded-md text-xs font-medium capitalize transition-colors ${activeTab === tab ? 'bg-white/10 text-white' : 'text-gray-500 hover:text-gray-300'
                                        }`}
                                >
                                    {tab}
                                </button>
