...
export const CrafterPanel: React.FC = () => {
    ...
    return (
        <div className="flex flex-col h-full bg-[#0D0D0D]">
            ...
            {!selectedNodeId && (
                <div
                    className={`absolute bottom-4 right-4 bg-surface border border-border rounded-lg shadow-2xl transition-all duration-300 ease-in-out flex flex-col ${isOutputExpanded ? 'w-[400px] h-[500px]' : 'w-72 h-auto'
                        }`}
                >
                    {/* Header */}
                    <div
